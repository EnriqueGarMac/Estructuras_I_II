...
ss.add_truss_element(location=[[0,4], [5,8]],EA=Ey*Ar)
ss.add_truss_element(location=[[0,4], [5,4]],EA=Ey*Ar)
ss.add_truss_element(location=[[0,4], [5,0]],EA=Ey*Ar)
ss.add_truss_element(location=[[5,0], [5,4]],EA=Ey*Ar)
ss.add_truss_element(location=[[5,4], [5,8]],EA=Ey*Ar)
...
ss.point_load(3, Fy=-10, Fx=-4)
ss.point_load(4, Fx=-8)
ss.point_load(5, Fx=-4)


# Mostramos estructura generada
ss.show_structure(title='Ejemplo PTV_Castigliano')
