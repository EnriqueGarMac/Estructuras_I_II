...
ss.add_element(location=[[2.0, 0.0], [3.0,0.0]])
ss.add_element(location=[[3.0, 0.0], [4.0,0.0]])

# Añadimos cargas
ss.q_load(element_id=4,  q=(0,15000))
ss.point_load(2, Fx=0, Fy=-20000)
...
#ss.solve()
ss.optimize(profile_type='IPN', fyd = 275/1.05, ELS = 2.0/400)
