...
# Añadimos elementos
ss.add_element(location=[[0.0, 0.0], [3.0,0.0]])
ss.add_element(location=[[3.0, 0.0], [6.0,0.0]])
ss.add_element(location=[[6.0, 0.0], [10.0,0.0]])

# Añadimos cargas
ss.q_load(element_id=3,  q=(0,60000))
